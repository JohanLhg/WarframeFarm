...
public class AddComponentDialog extends DialogFragment {
    private final Context context;
    private DialogAddItemBinding binding;
    private FarmDialogViewModel dialogViewModel;

    private SelectComponentAdapter itemAdapter;
    ...
    public AddComponentDialog(Context context) {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        titleAddItem.setText(R.string.title_add_components);
        ...
        itemAdapter = new SelectComponentAdapter(context);
        recyclerItems.setAdapter(itemAdapter);
        recyclerItems.setLayoutManager(new LinearLayoutManager(context));

        buttonAddItems.setText(R.string.button_add_component);
        buttonAddItems.setOnClickListener(v -> {
            List<String> componentNames = itemAdapter.getSelectedComponentNames();
            List<ComponentComplete> components = itemAdapter.getSelectedComponents();
            dialogViewModel.addComponents(componentNames, components);
            dismiss();
        });
        ...
        //region Observers
        dialogViewModel.getRemainingComponents().observe(getViewLifecycleOwner(), new Observer<List<ComponentComplete>>() {
            @Override
            public void onChanged(List<ComponentComplete> components) {
                itemAdapter.updateItems(components);
            }
        });
